...
<div class="container">
    <div class="row justify-content-center">
        <div class="p-0 col-md-10 d-flex justify-content-between align-items-center">
            <h2 class="putih" id="judul" >Kas Keluar</h2>
            <div>   
    ...
    <div class="row justify-content-center" id="containerData" >
      <div id="data${data.id}" data-bs-toggle="modal" data-bs-target="#createModal" data-id="${data.id}" data-type="show" class="data rounded col-md-10 my-1 bg-putih p-2 d-flex justify-content-between align-items-center">
        <div class="">
          <h4 data-bs-toggle="modal" data-bs-target="#createModal" data-id="${data.id}" data-type="show" data-edit="catatan" class="fieldEdit" >${data.catatan}</h4> 
          <h6 data-bs-toggle="modal" data-bs-target="#createModal" data-id="${data.id}" data-type="show" data-edit="uang" class="fieldEdit text-danger fw-bold p-0" >${data.uang}</h6> 
        </div>
        <div>
            <button type="button"  data-bs-toggle="modal" data-bs-target="#createModal" data-type="edit"  class="editButton btn btn-primary fw-bold" data-id="${data.id}" ><i data-id="${data.id}" data-type="edit"  data-bs-toggle="modal" data-bs-target="#createModal" class="editButton bi bi-pencil-square"></i></button>
          ...
          <form id="formCreate" data-method="POST" >
            ...
            <div class="bodyModal">
              ...
              <div class="mb-3 mt-2">
                ...
                <input type="text" maxlength="20" required class="form-control" id="catatan" name="catatan" >
              </div>
              <div class="mb-3 mt-2">
